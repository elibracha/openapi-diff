...
public class ConsoleRender implements Render {
    ...
    private String ul_security(ChangedSecurityRequirements apiSecurityReq) {
        List<SecurityRequirement> addSecurity = apiSecurityReq.getIncreased();
        List<SecurityRequirement> delSecurity = apiSecurityReq.getMissing();
        List<ChangedSecurityRequirement> changedSecurity = apiSecurityReq.getChanged();

        StringBuilder sb = new StringBuilder();

        if(changedSecurity != null)
          for (ChangedSecurityRequirement changedSecurityRequirement : changedSecurity) {
            if(changedSecurityRequirement.getNewSecurityRequirement() != null)
              sb.append(ItemSecurity("Changed New ", changedSecurityRequirement.getNewSecurityRequirement().toString()));
            if(changedSecurityRequirement.getOldSecurityRequirement() != null)
              sb.append(ItemSecurity("Changed Missing ", changedSecurityRequirement.getOldSecurityRequirement().toString()));
          }

      return sb.toString();
    }

    private String ItemSecurity(String title, String value) {
        StringBuilder sb = new StringBuilder();
